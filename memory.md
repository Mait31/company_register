...
项目目标：第一阶段只做公司注册自动化 MVP，用一套响应式网站跑通内部后台、客户资料收集、委托书材料收集、委托书内部草稿生成和后续公司归档主链路。
...
- 当前前端主链路不再要求先转正式 `registration_order`；三项委托书材料审核通过后直接生成委托书内部草稿。
...
P0：验收邀请资料台账、委托书材料收集、三项材料审核、委托书内部草稿生成这条主链路。

P1：补办理进度前端管理页，把委托书生成后的记录作为付费确认、办理启动、注册结果上传和公司归档入口。
