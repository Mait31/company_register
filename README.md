...
当前目标：只做到公司注册委托书模板生成。当前主线是客户通过微信卡片或邀请链接填写资料，内部人员在网站后台核对资料并收集委托书材料，材料审核通过后直接基于 Word 模板生成委托书 DOCX 内部草稿；这条链路稳定后，项目先暂停。
...
- 第一阶段不要求先转正式 `registration_order` 才生成委托书；材料审核通过后直接基于 Word 模板生成 DOCX 内部草稿。
- 当前不再推进付费确认、办理启动、注册结果上传、公司最终归档等后续计划。
